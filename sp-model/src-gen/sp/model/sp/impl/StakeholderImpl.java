 ...
 * </p>
 * <ul>
 *   <li>{@link sp.model.sp.impl.StakeholderImpl#getWorkitem <em>Workitem</em>}</li>
 * </ul>
 *
 * @generated
 */
public class StakeholderImpl extends MinimalEObjectImpl.Container implements Stakeholder {
	...
	protected EClass eStaticClass() {
		return SPPackage.Literals.STAKEHOLDER;
	}
	...
	public EList<WorkItem> getWorkitem() {
		if (workitem == null) {
			workitem = new EObjectWithInverseResolvingEList<WorkItem>(WorkItem.class, this,
					SPPackage.STAKEHOLDER__WORKITEM, SPPackage.WORK_ITEM__STAKEHOLDER);
		}
		return workitem;
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case SPPackage.STAKEHOLDER__WORKITEM:
