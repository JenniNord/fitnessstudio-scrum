 ...
 * </p>
 * <ul>
 *   <li>{@link sp.model.sp.impl.BacklogImpl#getWorkitems <em>Workitems</em>}</li>
 * </ul>
 *
 * @generated
 */
public class BacklogImpl extends MinimalEObjectImpl.Container implements Backlog {
	...
	protected EClass eStaticClass() {
		return SPPackage.Literals.BACKLOG;
	}
	...
	public EList<WorkItem> getWorkitems() {
		if (workitems == null) {
			workitems = new EObjectContainmentEList<WorkItem>(WorkItem.class, this, SPPackage.BACKLOG__WORKITEMS);
		}
		return workitems;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case SPPackage.BACKLOG__WORKITEMS:
